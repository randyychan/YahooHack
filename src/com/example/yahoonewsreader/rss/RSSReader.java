package com.example.yahoonewsreader.rss;
...
public class RSSReader {
	...
	public String getImageURL(Element item, String key) {
		NodeList nodeList = item.getElementsByTagName(key);
		if (nodeList.getLength() > 0 && nodeList.item(0).hasAttributes()) {
			return nodeList.item(0).getAttributes().getNamedItem("url").getNodeValue();
		}
		return null;
	}
